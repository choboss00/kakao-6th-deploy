...
==== 응답 예시
include::{snippets}/{user}/join-error_4test/response-body.adoc[]
...
==== 요청 예시
include::{snippets}/{order}/save-error2_test/http-request.adoc[]

==== 응답 예시
include::{snippets}/{order}/save-error2_test/response-body.adoc[]
